...
pub mod nft_club {
    ...
    pub fn create_benefit(
        ...
        components::create_benefit(ctx, name, description, link, benefit_number)
    }
    ...
    pub fn update_benefit(ctx: Context<UpdateBenefit>, name: String, description: String, link: String, benefit_number: String) -> Result<()> {
        components::update_benefit(ctx, name, description, link, benefit_number)
    }
}
